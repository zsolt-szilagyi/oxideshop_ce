...
class Unit_Core_oxDbTest extends OxidTestCase
{
    ...
    public function testIsValidFieldName()
    {
        ...
        $this->assertTrue($oDb->isValidFieldName('oxid_de'));
    ...
    public function testTransactions()
    {
        if ($this->getTestConfig()->getShopEdition() == 'EE') {
            $sQ1 = "INSERT INTO `oxarticles` (`OXID`, `OXSHOPID`, `OXPARENTID`, `OXACTIVE`, `OXACTIVEFROM`, `OXACTIVETO`, `OXARTNUM`, `OXEAN`, `OXDISTEAN`, `OXMPN`, `OXTITLE_DE`, `OXSHORTDESC_DE`, `OXPRICE`, `OXBLFIXEDPRICE`, `OXPRICEA`, `OXPRICEB`, `OXPRICEC`, `OXBPRICE`, `OXTPRICE`, `OXUNITNAME`, `OXUNITQUANTITY`, `OXEXTURL`, `OXURLDESC_DE`, `OXURLIMG`, `OXVAT`, `OXTHUMB`, `OXICON`, `OXPIC1`, `OXPIC2`, `OXPIC3`, `OXPIC4`, `OXPIC5`, `OXPIC6`, `OXPIC7`, `OXPIC8`, `OXPIC9`, `OXPIC10`, `OXPIC11`, `OXPIC12`, `OXWEIGHT`, `OXSTOCK`, `OXSTOCKFLAG`, `OXSTOCKTEXT_DE`, `OXNOSTOCKTEXT_DE`, `OXDELIVERY`, `OXINSERT`, `OXTIMESTAMP`, `OXLENGTH`, `OXWIDTH`, `OXHEIGHT`, `OXFILE`, `OXSEARCHKEYS_DE`, `OXTEMPLATE`, `OXQUESTIONEMAIL`, `OXISSEARCH`, `OXISCONFIGURABLE`, `OXVARNAME_DE`, `OXVARSTOCK`, `OXVARCOUNT`, `OXVARSELECT_DE`, `OXVARMINPRICE`, `OXVARNAME_EN`, `OXVARSELECT_EN`, `OXVARNAME_FR`, `OXVARSELECT_FR`, `OXVARNAME`, `OXVARSELECT`, `OXTITLE_EN`, `OXSHORTDESC_EN`, `OXURLDESC_EN`, `OXSEARCHKEYS_EN`, `OXTITLE_FR`, `OXSHORTDESC_FR`, `OXURLDESC_FR`, `OXSEARCHKEYS_FR`, `OXTITLE`, `OXSHORTDESC`, `OXURLDESC`, `OXSEARCHKEYS`, `OXFOLDER`, `OXSUBCLASS`, `OXSTOCKTEXT_EN`, `OXSTOCKTEXT_FR`, `OXSTOCKTEXT`, `OXNOSTOCKTEXT_EN`, `OXNOSTOCKTEXT_FR`, `OXNOSTOCKTEXT`, `OXSORT`, `OXSOLDAMOUNT`, `OXNONMATERIAL`, `OXFREESHIPPING`, `OXREMINDACTIVE`, `OXREMINDAMOUNT`, `OXAMITEMID`, `OXAMTASKID`, `OXVENDORID`, `OXMANUFACTURERID`, `OXSKIPDISCOUNTS`, `OXORDERINFO`, `OXPIXIEXPORT`, `OXPIXIEXPORTED`, `OXVPE`, `OXRATING`, `OXRATINGCNT`, `OXMINDELTIME`, `OXMAXDELTIME`, `OXDELTIMEUNIT`, `OXUPDATEPRICE`, `OXUPDATEPRICEA`, `OXUPDATEPRICEB`, `OXUPDATEPRICEC`, `OXUPDATEPRICETIME`, `OXISDOWNLOADABLE`) VALUES
            ...
            $sQ1 = "INSERT INTO `oxarticles` (`OXID`, `OXSHOPID`, `OXPARENTID`, `OXACTIVE`, `OXACTIVEFROM`, `OXACTIVETO`, `OXARTNUM`, `OXEAN`, `OXDISTEAN`, `OXMPN`, `OXTITLE_DE`, `OXSHORTDESC_DE`, `OXPRICE`, `OXBLFIXEDPRICE`, `OXPRICEA`, `OXPRICEB`, `OXPRICEC`, `OXBPRICE`, `OXTPRICE`, `OXUNITNAME`, `OXUNITQUANTITY`, `OXEXTURL`, `OXURLDESC_DE`, `OXURLIMG`, `OXVAT`, `OXTHUMB`, `OXICON`, `OXPIC1`, `OXPIC2`, `OXPIC3`, `OXPIC4`, `OXPIC5`, `OXPIC6`, `OXPIC7`, `OXPIC8`, `OXPIC9`, `OXPIC10`, `OXPIC11`, `OXPIC12`, `OXWEIGHT`, `OXSTOCK`, `OXSTOCKFLAG`, `OXSTOCKTEXT_DE`, `OXNOSTOCKTEXT_DE`, `OXDELIVERY`, `OXINSERT`, `OXTIMESTAMP`, `OXLENGTH`, `OXWIDTH`, `OXHEIGHT`, `OXFILE`, `OXSEARCHKEYS_DE`, `OXTEMPLATE`, `OXQUESTIONEMAIL`, `OXISSEARCH`, `OXISCONFIGURABLE`, `OXVARNAME_DE`, `OXVARSTOCK`, `OXVARCOUNT`, `OXVARSELECT_DE`, `OXVARMINPRICE`, `OXVARNAME_EN`, `OXVARSELECT_EN`, `OXVARNAME_FR`, `OXVARSELECT_FR`, `OXVARNAME`, `OXVARSELECT`, `OXTITLE_EN`, `OXSHORTDESC_EN`, `OXURLDESC_EN`, `OXSEARCHKEYS_EN`, `OXTITLE_FR`, `OXSHORTDESC_FR`, `OXURLDESC_FR`, `OXSEARCHKEYS_FR`, `OXTITLE`, `OXSHORTDESC`, `OXURLDESC`, `OXSEARCHKEYS`, `OXBUNDLEID`, `OXFOLDER`, `OXSUBCLASS`, `OXSTOCKTEXT_EN`, `OXSTOCKTEXT_FR`, `OXSTOCKTEXT`, `OXNOSTOCKTEXT_EN`, `OXNOSTOCKTEXT_FR`, `OXNOSTOCKTEXT`, `OXSORT`, `OXSOLDAMOUNT`, `OXNONMATERIAL`, `OXFREESHIPPING`, `OXREMINDACTIVE`, `OXREMINDAMOUNT`, `OXAMITEMID`, `OXAMTASKID`, `OXVENDORID`, `OXMANUFACTURERID`, `OXSKIPDISCOUNTS`, `OXRATING`, `OXRATINGCNT`, `OXMINDELTIME`, `OXMAXDELTIME`, `OXDELTIMEUNIT`) VALUES
