[{capture append="oxidBlock_content"}]
    <h1 class="page-header">Metadata version 2.0 other test module (with namespace) - [{$the_module_message}]</h1>

    <form action="[{$oViewConf->getSelfActionLink()}]" name="MyModuleControllerAction" method="post" role="form">
        <div>
            [{$oViewConf->getHiddenSid()}]
            <input type="hidden" name="cl" value="vendor2_metadatav2demo_mymodulecontroller">
